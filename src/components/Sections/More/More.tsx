            ...
            <MoreInnerContainer>
                <div className="row">
                    <MoreCardOuter>
                        <SingleMoreCard>
                        <BlackOverlapped/>
                            <Image className="position-absolute" src={renderImage.more_bg_1} alt="My other works" width={200} height={200} priority/>
                            <MoreCardContent>
                    ...
                    <MoreCardOuter>
                        <SingleMoreCard>
                            <BlackOverlapped/>
                            <Image className="position-absolute" src={renderImage.more_bg_2} alt="My tech blog" width={200} height={200} priority/>
                            <MoreCardContent>
                                <H4>My tech blog</H4>

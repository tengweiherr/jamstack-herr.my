    ...
    <section className="contact my-5" ref={aniRef}>
        <div className="container contact-inner">
            ...
            <div className="col-lg-6">
                ...
                <TextContainer>
                    <p className="description py-2">Drop me a message if you have any questions or just want to say hi. <br />Any collaborations and opportunities are welcomed.</p>
                </TextContainer>

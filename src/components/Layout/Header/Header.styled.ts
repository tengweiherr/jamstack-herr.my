...
export const Navbar = styled.nav.attrs(props=>({
    className: 'navbar navbar-expand-lg ' + (props.className ? props.className : '')
}))`
...
export const NavbarItemList = styled.ul.attrs(props=>({
    className: 'navbar-nav mx-auto justify-content-around align-items-center w-100 ' + (props.className ? props.className : '')
}))`
    padding: 1rem 3rem; 
